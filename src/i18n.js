...
window.NBT = (function (ns) {
  ...
  const dict = {
    en: {
      ...
      'menu.exportDat': 'Export as .dat',
      'menu.moveUp': 'Move up',
      'menu.moveDown': 'Move down',
      'menu.bookmark': 'Bookmark path',
      'toast.copiedPath': 'Path copied: {0}',
      'toast.bookmarked': 'Bookmarked',
      'toast.unbookmarked': 'Bookmark removed',
      'toast.noBookmarks': 'No bookmarks yet',
      'toast.bmMissing': 'Bookmark path not found in this document',
      'toast.bmCleared': 'Bookmarks cleared',
      'tab.switch': 'Alt+{0}',
      'tab.close': 'Close tab',
      'goto.pathPrompt': 'Path (e.g. Data/Player/Pos):',
      'goto.offsetPrompt': 'Hex offset:',
      'goto.notFound': 'Not found',
      'goto.noHex': 'Enable hex view first',
      'theme.dark': 'Dark',
      'theme.light': 'Light',
      'theme.sepia': 'Sepia',
      ...
      'theme.accent': '▾ Accent',
      'theme.resetAccent': 'Reset accent',
      'bookmarks.clear': 'Clear bookmarks',
      'btn.collapse.title': 'Collapse all (Ctrl+[)',
      'btn.expand.title': 'Expand all (Ctrl+])',
      'btn.goto.title': 'Go to path (Ctrl+P)',
      'btn.gotoOffset.title': 'Go to offset (Ctrl+G)',
      'btn.bookmarks.title': 'Bookmarks',
      'btn.history.title': 'Undo history',
      'history.entry': 'state {0}',
      'history.undo': 'undo point',
      'history.empty': 'No undo history yet',
      'history.clear': 'Clear history',
      'history.cleared': 'History cleared',
      'multi.delete': 'Delete {0} tags',
      'multi.duplicate': 'Duplicate {0} tags',
      'multi.renamePrefix': 'Rename with prefix…',
      'multi.prefixPrompt': 'Prefix for selected keys:',
      'toast.multiOnlyCompound': 'Rename-with-prefix only works on compound members',
    ...
    es: {
      ...
      'menu.exportDat': 'Exportar como .dat',
      'menu.moveUp': 'Subir',
      'menu.moveDown': 'Bajar',
      'menu.bookmark': 'Marcar ruta',
      'toast.copiedPath': 'Ruta copiada: {0}',
      'toast.bookmarked': 'Marcado',
      'toast.unbookmarked': 'Marca eliminada',
      'toast.noBookmarks': 'Aún no hay marcas',
      'toast.bmMissing': 'La ruta marcada no existe en este documento',
      'toast.bmCleared': 'Marcas borradas',
      'tab.switch': 'Alt+{0}',
      'tab.close': 'Cerrar pestaña',
      'goto.pathPrompt': 'Ruta (p. ej. Data/Player/Pos):',
      'goto.offsetPrompt': 'Desplazamiento hex:',
      'goto.notFound': 'No encontrado',
      'goto.noHex': 'Activa la vista hex primero',
      'theme.dark': 'Oscuro',
      'theme.light': 'Claro',
      'theme.sepia': 'Sepia',
      'theme.gruvbox': 'Gruvbox',
      ...
      'theme.accent': '▾ Acento',
      'theme.resetAccent': 'Restablecer acento',
      'bookmarks.clear': 'Borrar marcas',
      'btn.collapse.title': 'Contraer todo (Ctrl+[)',
      'btn.expand.title': 'Expandir todo (Ctrl+])',
      'btn.goto.title': 'Ir a ruta (Ctrl+P)',
      'btn.gotoOffset.title': 'Ir a desplazamiento (Ctrl+G)',
      'btn.bookmarks.title': 'Marcas',
      'btn.history.title': 'Historial de deshacer',
      'history.entry': 'estado {0}',
      'history.undo': 'punto de deshacer',
      'history.empty': 'Aún no hay historial',
      'history.clear': 'Borrar historial',
      'history.cleared': 'Historial borrado',
      'multi.delete': 'Eliminar {0} etiquetas',
      'multi.duplicate': 'Duplicar {0} etiquetas',
      'multi.renamePrefix': 'Renombrar con prefijo…',
      'multi.prefixPrompt': 'Prefijo para las claves seleccionadas:',
      'toast.multiOnlyCompound': 'Renombrar con prefijo solo funciona en miembros de compound',
    ...
    ru: {
      ...
      'menu.exportDat': 'Экспорт в .dat',
      'menu.moveUp': 'Вверх',
      'menu.moveDown': 'Вниз',
      'menu.bookmark': 'Закладка на путь',
      'toast.copiedPath': 'Путь скопирован: {0}',
      'toast.bookmarked': 'Закладка добавлена',
      'toast.unbookmarked': 'Закладка удалена',
      'toast.noBookmarks': 'Закладок пока нет',
      'toast.bmMissing': 'Путь закладки не найден в этом документе',
      'toast.bmCleared': 'Закладки очищены',
      'tab.switch': 'Alt+{0}',
      'tab.close': 'Закрыть вкладку',
      'goto.pathPrompt': 'Путь (напр. Data/Player/Pos):',
      'goto.offsetPrompt': 'Hex-смещение:',
      'goto.notFound': 'Не найдено',
      'goto.noHex': 'Сначала включите hex-вид',
      'theme.dark': 'Тёмная',
      'theme.light': 'Светлая',
      'theme.sepia': 'Сепия',
      ...
      'theme.accent': '▾ Акцент',
      'theme.resetAccent': 'Сбросить акцент',
      'bookmarks.clear': 'Очистить закладки',
      'btn.collapse.title': 'Свернуть всё (Ctrl+[)',
      'btn.expand.title': 'Развернуть всё (Ctrl+])',
      'btn.goto.title': 'Перейти к пути (Ctrl+P)',
      'btn.gotoOffset.title': 'Перейти к смещению (Ctrl+G)',
      'btn.bookmarks.title': 'Закладки',
      'btn.history.title': 'История отмен',
      'history.entry': 'состояние {0}',
      'history.undo': 'точка отмены',
      'history.empty': 'Истории пока нет',
      'history.clear': 'Очистить историю',
      'history.cleared': 'История очищена',
      'multi.delete': 'Удалить {0} тегов',
      'multi.duplicate': 'Дублировать {0} тегов',
      'multi.renamePrefix': 'Переименовать с префиксом…',
      'multi.prefixPrompt': 'Префикс для выбранных ключей:',
      'toast.multiOnlyCompound': 'Переименование с префиксом работает только для членов compound',
    ...
    zh: {
      ...
      'menu.copyPath': '复制路径',
      'menu.exportDat': '导出为 .dat',
      'menu.moveUp': '上移',
      'menu.moveDown': '下移',
      'menu.bookmark': '收藏路径',
      'toast.copiedPath': '路径已复制：{0}',
      'toast.bookmarked': '已收藏',
      'toast.unbookmarked': '已取消收藏',
      'toast.noBookmarks': '暂无收藏',
      'toast.bmMissing': '收藏路径在此文档中不存在',
      'toast.bmCleared': '已清除收藏',
      'tab.switch': 'Alt+{0}',
      'tab.close': '关闭标签页',
      'goto.pathPrompt': '路径（例如 Data/Player/Pos）：',
      'goto.offsetPrompt': '十六进制偏移：',
      'goto.notFound': '未找到',
      'goto.noHex': '请先启用十六进制视图',
      'theme.dark': '深色',
      'theme.light': '浅色',
      'theme.sepia': '棕褐',
      'theme.gruvbox': 'Gruvbox',
      'theme.contrast': '高对比度',
      'theme.accent': '▾ 强调色',
      'theme.resetAccent': '重置强调色',
      'bookmarks.clear': '清除收藏',
      'btn.collapse.title': '全部折叠 (Ctrl+[)',
      'btn.expand.title': '全部展开 (Ctrl+])',
      'btn.goto.title': '跳转到路径 (Ctrl+P)',
      'btn.gotoOffset.title': '跳转到偏移 (Ctrl+G)',
      'btn.bookmarks.title': '收藏',
      'btn.history.title': '撤销历史',
      'history.entry': '状态 {0}',
      'history.undo': '撤销点',
      'history.empty': '暂无撤销历史',
      'history.clear': '清除历史',
      'history.cleared': '历史已清除',
      'multi.delete': '删除 {0} 个标签',
      'multi.duplicate': '复制 {0} 个标签',
      'multi.renamePrefix': '添加前缀重命名…',
      'multi.prefixPrompt': '所选键的前缀：',
      'toast.multiOnlyCompound': '带前缀重命名仅适用于 compound 成员',
    ...
    ja: {
      ...
      'menu.exportDat': '.dat としてエクスポート',
      'menu.moveUp': '上へ',
      'menu.moveDown': '下へ',
      'menu.bookmark': 'パスをブックマーク',
      'toast.copiedPath': 'パスをコピーしました: {0}',
      'toast.bookmarked': 'ブックマークに追加',
      'toast.unbookmarked': 'ブックマークを解除',
      'toast.noBookmarks': 'ブックマークはまだありません',
      'toast.bmMissing': 'ブックマークのパスがこのドキュメントにありません',
      'toast.bmCleared': 'ブックマークをクリア',
      'tab.switch': 'Alt+{0}',
      'tab.close': 'タブを閉じる',
      'goto.pathPrompt': 'パス（例: Data/Player/Pos）:',
      'goto.offsetPrompt': '16進オフセット:',
      'goto.notFound': '見つかりません',
      'goto.noHex': '最初に 16進ビューを有効にしてください',
      'theme.dark': 'ダーク',
      'theme.light': 'ライト',
      'theme.sepia': 'セピア',
      'theme.gruvbox': 'Gruvbox',
      ...
      'theme.accent': '▾ アクセント',
      'theme.resetAccent': 'アクセントをリセット',
      'bookmarks.clear': 'ブックマークをクリア',
      'btn.collapse.title': 'すべて折りたたみ (Ctrl+[)',
      'btn.expand.title': 'すべて展開 (Ctrl+])',
      'btn.goto.title': 'パスへ移動 (Ctrl+P)',
      'btn.gotoOffset.title': 'オフセットへ移動 (Ctrl+G)',
      'btn.bookmarks.title': 'ブックマーク',
      'btn.history.title': '元に戻す履歴',
      'history.entry': '状態 {0}',
      'history.undo': '元に戻すポイント',
      'history.empty': '履歴はまだありません',
      'history.clear': '履歴をクリア',
      'history.cleared': '履歴をクリアしました',
      'multi.delete': '{0} タグを削除',
      'multi.duplicate': '{0} タグを複製',
      'multi.renamePrefix': 'プレフィックス付きで名前変更…',
      'multi.prefixPrompt': '選択したキーのプレフィックス:',
      'toast.multiOnlyCompound': 'プレフィックス付き名前変更は compound メンバーのみ可能です',
